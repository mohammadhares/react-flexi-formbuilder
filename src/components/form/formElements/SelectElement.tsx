...
const SelectElement = ({ field, onRemoveField, onEditField }: SelectElementProps) => {
    ...
    return (
        <div key={field.id} className={field.className}>
            <div className="form-element frm-element">
                ...
                <select defaultValue={field.value} required={field.required}>
                    ...
                    <div className="edit-form">
                        ...
                        <div className="form-field mt-2">
                            ...
                            <input
                                ...
                                onChange={(e) => onEditField(field.id, { placeholder: e.target.value })}
                            />
                        </div>
                        <div className="form-field mt-2">
